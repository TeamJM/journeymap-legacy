...
public class PngReader
{
     ...
     *
     * @param filenameOrDescription : Optional, can be a filename or a description. Just for error/debug messages
     */
     ...
     *
     * @param nrow Row number, from 0 to rows-1. Increasing order.
     ...
     * @param nrow   Row number (0 is top). Most be strictly greater than the last read row.
     ...
     *
     * @param rowOffset Number of rows to be skipped
     * @param nRows     Total number of rows to be read. -1: read all available
     * @param rowStep   Row increment. If 1, we read consecutive lines; if 2, we read even/odd lines, etc
